        ...
        if settings['auto_delete']:
            btn.insert(0, 
                [
                    ...
                    InlineKeyboardButton("𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞🔰", callback_data=f"select_lang#{req}")
...
#       
        ...
        buttons = [[
            InlineKeyboardButton('🍷 ᴍᴏʀᴇ ғᴇᴀᴛᴜʀᴇs 🍷', callback_data='modules1')
        ], [
    ...
    try:
        ...
        if settings['auto_delete']:
            btn.insert(0, 
                [
                    InlineKeyboardButton(f'🔰𝐅𝐢𝐥𝐞𝐬: {len(files)}', 'dupe'),
                    InlineKeyboardButton("𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞🔰", callback_data=f"select_lang#{message.from_user.id}")
